<p align="center">
  <img src="assets/banner.svg" alt="Flawed Shell - quiet by default." width="720"/>
</p>

**Flawed Shell** — a Quickshell shell for Hyprland: bar, control menu, notifications, matugen/manual theming, night light, and optional cava visualizer.
...
<p align="center">
  <img src="assets/showcase.png" alt="Flawed Shell showcase" width="900"/>
</p>
...
```bash
git clone https://github.com/Flawedexa/Flawed-Shell
cd Flawed-Shell
bash scripts/install.sh
```

The installer copies Flawed Shell to `$XDG_CONFIG_HOME/Flawed-Shell`, backs up existing files, and adds a marked Hyprland autostart block. Restart Hyprland, then verify with `bash scripts/check.sh`. Remove everything again with `bash scripts/uninstall.sh`.
